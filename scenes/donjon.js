...
if (essencepris == 0){
    essencesup = this.physics.add.image(700,550,'essence');
}
    ////////arrivée du joueur\\\\\\\\\\
if(spawn == "droite"){
...
//robot 1
    ...
    if(robot == 1) {robot2 = this.physics.add.sprite(390, 90, 'robot_face');}
    else if(robot == 2) {robot2 = this.physics.add.sprite(450, 90, 'robot_face');}
    else if(robot == 3) {robot2 = this.physics.add.sprite(450, 550, 'robot_face');}
    else if(robot == 4) {robot2 = this.physics.add.sprite(390, 550, 'robot_face');}

//piques
    pique6 = this.physics.add.image(500,400, 'pique').setScale(0.10);
    pique7 = this.physics.add.image(250,300, 'pique').setScale(0.10);
    pique8 = this.physics.add.image(250,130, 'pique').setScale(0.10);
    pique9 = this.physics.add.image(250,470, 'pique').setScale(0.10);
    pique10 = this.physics.add.image(580,550, 'pique').setScale(0.10);
    pique11 = this.physics.add.image(600,450, 'pique').setScale(0.10);
////////collisions\\\\\\\\\\\
...
//robot2
    if (robot2.x <= 390 && robot2.y <= 90) {
      ...
      robot2.setVelocityX(130);
    } else if (robot2.x >= 450 && robot2.y <= 90) {
      robot2.setFlipX(false);
      robot2.setVelocityY(130);
      robot2.setVelocityX(0);
    } else if (robot2.x >= 450 && robot2.y >= 550) {
      robot2.setVelocityY(0);
      robot2.setVelocityX(-130);
